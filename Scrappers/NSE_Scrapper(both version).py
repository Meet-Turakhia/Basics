...
# ie_options.add_experimental_option('prefs', prefs)
# browser = webdriver.Chrome(ie_options = ie_options)
        ...
        if expiry_dates.loc[i, "Weekly"] == 1:
            ...
            while(s < totalOptiontype):
                ...
                WebDriverWait(driver, 120).until(EC.presence_of_element_located((
                    By.XPATH, "//*[@id='historicalData']/div[1]/span[2]/a")))
                downloadData = driver.find_element_by_xpath("//*[@id='historicalData']/div[1]/span[2]/a")
                downloadData.click()
                time.sleep(2)
